 ...
 *
 * Otherwise we should move the computed properties to the ViewModel [BaseViewModel] (e.g.: formatting a string)
 * or to the business logic [BaseUseCase] (e.g.: sorting a list)  or create a mapper.
 *
 * Example:
 * ```kotlin
