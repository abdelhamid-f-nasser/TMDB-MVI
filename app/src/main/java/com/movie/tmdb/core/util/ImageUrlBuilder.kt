...
object ImageUrlBuilder {
     ...
     */
    fun buildPosterUrl(posterPath: String?, size: String = ApiConstants.ImageSizes.POSTER_W500): String? {
     ...
     */
    fun buildBackdropUrl(backdropPath: String?, size: String = ApiConstants.ImageSizes.BACKDROP_W780): String? {
