...
class ImageUrlBuilderTest {
	...
	fun `buildPosterUrl should return correct URL for valid poster path`() {
		...
		val expectedUrl =
			"${ApiConstants.TMDB_IMAGE_BASE_URL}${ApiConstants.ImageSizes.POSTER_W500}$posterPath"
	...
	fun `buildBackdropUrl should return correct URL for valid backdrop path`() {
		...
		val expectedUrl =
			"${ApiConstants.TMDB_IMAGE_BASE_URL}${ApiConstants.ImageSizes.BACKDROP_W780}$backdropPath"
